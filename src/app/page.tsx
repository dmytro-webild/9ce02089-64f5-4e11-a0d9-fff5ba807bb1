...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Stephen H.",          handle: "Customer",          testimonial: "Absolutely a top notch job. They arrived quickly and got my car unstuck fast. They are my new go-to company.",          rating: 5,
        ...
        {
          name: "Sarah M.",          handle: "Customer",          testimonial: "Called them for a flat tire, and they were there in record time. Super professional and friendly. Highly recommend!",          rating: 5,
        ...
        {
          name: "James K.",          handle: "Customer",          testimonial: "My car broke down late at night. All American Towing responded so quickly and towed me safely home. Couldn't be more grateful.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/woman-with-coffee-cup-showing-thumb-up_23-2148055893.jpg"},
        {
          name: "Emily R.",          handle: "Customer",          testimonial: "Needed a tow after a minor accident. They handled everything with care and made a stressful situation much easier. Great service!",          rating: 5,
      ...
      buttons={[
        {
          text: "GET IMMEDIATE HELP (716) 229-1007",          href: "tel:+17162291007"},
        {
  ...
  <div id="why-choose-us" data-section="why-choose-us">
      ...
      bulletPoints={[
        {
          title: "Veteran-Owned & Operated",          description: "Proudly a veteran-owned business, committed to discipline, integrity, and reliable service for our community.",          icon: Flag,
        },
        {
          title: "24/7 Rapid Response",          description: "Emergencies don't wait. Our team is ready around the clock to provide immediate assistance, day or night.",          icon: Clock,
        },
        {
          title: "Transparent Pricing",          description: "No hidden fees. We believe in honest, upfront quotes, so you always know what to expect.",          icon: DollarSign,
        },
        {
          title: "Experienced Professionals",          description: "Our certified tow operators are skilled, courteous, and equipped to handle any situation safely and efficiently.",          icon: Cog,
        },
        {
          title: "Local Boston, NY Service",          description: "As a local business, we know the area and are dedicated to serving our neighbors with unparalleled speed and care.",          icon: MapPin,
        },
      ]}
